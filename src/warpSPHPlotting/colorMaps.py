...
class Sequential2ColorMap(Enum):
    binary = 'binary'
    gist_yarg = 'gist_yarg'
    gist_gray = 'gist_gray'
    gray = 'gray'
...
qualitativeColorMaps = ['Pastel1', 'Pastel2', 'Paired', 'Accent', 'Dark2',
                      ...
                      'tab20c']
class QualitativeColorMap(Enum):
    Pastel1 = 'Pastel1'
    Pastel2 = 'Pastel2'
    Paired = 'Paired'
    Accent = 'Accent'
...
class MiscellaneousColorMap(Enum):
    flag = 'flag'
    prism = 'prism'
    ocean = 'ocean'
